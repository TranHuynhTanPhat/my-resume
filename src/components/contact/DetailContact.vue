  ...
  <div class="wrapper">
    <div class="avatar">
      <div class="avatar-container">
        <img src="@/assets/avatar.jpg" alt="Trần Huỳnh Tấn Phát" />
      </div>
    </div>
    <div class="contact">
      <a
        href="https://www.facebook.com/tranhuynhtanphat.852"
        target="_blank"
      ...
      >
        ...
        <div class="contact-container-title">Trần Huỳnh Tấn Phát</div>
      </a>
      <a href="mailto:tranhuynhtanphat9380@gmail.com" class="contact-container">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="32"
          height="32"
      ...
      <a
        href="https://www.linkedin.com/in/phat-tran-huynh-tan-284b7328a/"
        target="_blank"
        class="contact-container"
        ><svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="contact-container-title">LinkedIn</div></a
      >
      <a
        href="https://github.com/TranHuynhTanPhat"
        target="_blank"
        class="contact-container"
        ><svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="contact-container-title">Github</div></a
      >
    </div>
  </div>
</template>
